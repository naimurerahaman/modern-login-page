      ...
      <div className="form-panel">
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {!isLogin && (
              <div
                className="input-group slide-in"
                style={{ animationDelay: "0s" }}
              >
                <label
                  htmlFor="name"
                  className={
                    focusedField === "name" || formData.name ? "float" : ""
                  }
                >
                  Full Name
                </label>
            ...
            >
              <label
                htmlFor="email"
                className={
                  focusedField === "email" || formData.email ? "float" : ""
                }
              >
                Email Address
              </label>
            ...
            {isLogin && (
              <div
                className="forgot-password slide-in"
            ...
            <button
              type="submit"
              className={`submit-btn slide-in ${isLoading ? "loading" : ""}`}
              disabled={isLoading}
          ...
          <div className="divider slide-in" style={{ animationDelay: "0.3s" }}>
            <span>or continue with</span>
          </div>

          <div
            className="social-btn slide-in"
